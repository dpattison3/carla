...
_MEASUREMENTS_PLAYERMEASUREMENTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='velocity', full_name='carla_server.Measurements.PlayerMeasurements.velocity', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='angular_rate', full_name='carla_server.Measurements.PlayerMeasurements.angular_rate', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='forward_speed', full_name='carla_server.Measurements.PlayerMeasurements.forward_speed', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='collision_vehicles', full_name='carla_server.Measurements.PlayerMeasurements.collision_vehicles', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='collision_pedestrians', full_name='carla_server.Measurements.PlayerMeasurements.collision_pedestrians', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='collision_other', full_name='carla_server.Measurements.PlayerMeasurements.collision_other', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='intersection_otherlane', full_name='carla_server.Measurements.PlayerMeasurements.intersection_otherlane', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='intersection_offroad', full_name='carla_server.Measurements.PlayerMeasurements.intersection_offroad', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='autopilot_control', full_name='carla_server.Measurements.PlayerMeasurements.autopilot_control', index=11,
...
_MEASUREMENTS_PLAYERMEASUREMENTS.fields_by_name['velocity'].message_type = _VECTOR3D
_MEASUREMENTS_PLAYERMEASUREMENTS.fields_by_name['angular_rate'].message_type = _VECTOR3D
